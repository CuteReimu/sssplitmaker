...
var SplitsCache = []*SplitData{
	...
	{"Mask5", "面具碎片20（碎片）"},
	{"SpoolFragment1", "丝之轴碎片1（碎片）"},
	{"Spool1", "丝之轴碎片2（碎片）"},
	{"SpoolFragment3", "丝之轴碎片3（碎片）"},
	{"Spool2", "丝之轴碎片4（碎片）"},
	{"SpoolFragment5", "丝之轴碎片5（碎片）"},
	{"Spool3", "丝之轴碎片6（碎片）"},
	{"SpoolFragment7", "丝之轴碎片7（碎片）"},
	{"Spool4", "丝之轴碎片8（碎片）"},
	{"SpoolFragment9", "丝之轴碎片9（碎片）"},
	{"Spool5", "丝之轴碎片10（碎片）"},
	{"SpoolFragment11", "丝之轴碎片11（碎片）"},
	{"Spool6", "丝之轴碎片12（碎片）"},
	{"SpoolFragment13", "丝之轴碎片13（碎片）"},
	{"Spool7", "丝之轴碎片14（碎片）"},
	{"SpoolFragment15", "丝之轴碎片15（碎片）"},
	{"Spool8", "丝之轴碎片16（碎片）"},
	{"SpoolFragment17", "丝之轴碎片17（碎片）"},
	{"Spool9", "丝之轴碎片18（碎片）"},
