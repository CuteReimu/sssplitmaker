...
var SplitsCache = []*SplitData{
	...
	{ID: "DeliveredCouriersRasher", Description: "送货员熏肉交付（事件）"},
	...
	{ID: "YarnabySlap", Description: "雅纳碧掌掴（事件）"},
	{ID: "WidowEncountered", Description: "黑寡妇-遭遇（Boss）"},
	{ID: "OnObtainMaskShard", Description: "面具碎片（获得）"},
	{ID: "HunterCrestEvo1", Description: "猎手纹章进化1（升级）"},
	{ID: "VesticrestYellowSlot", Description: "蜕型纹章-黄槽（升级）"},
	{ID: "VesticrestBlueSlot", Description: "蜕型纹章-蓝槽（升级）"},
	{ID: "HunterCrestEvo2", Description: "猎手纹章进化2（升级）"},
	{ID: "VentricaTrans", Description: "圣脉枢管（切图）"},
	{ID: "AscendantsGrip", Description: "登极握爪（工具）"},
	{ID: "BarbedBracelet", Description: "棘刺手环（工具）"},
	{ID: "ClawMirror", Description: "爪镜（工具）"},
	{ID: "ClawMirrors", Description: "双生爪镜（工具）"},
	{ID: "Cogfly", Description: "齿轮蜂（工具）"},
	{ID: "CogworkWheel", Description: "机轮刃（工具）"},
	{ID: "Compass", Description: "罗盘（工具）"},
	{ID: "Conchcutter", Description: "螺切刃（工具）"},
	{ID: "Curveclaw", Description: "弧爪（工具）"},
	{ID: "Curvesickle", Description: "曲镰（工具）"},
	{ID: "DeadBugsPurse", Description: "亡虫囊（工具）"},
	{ID: "DelversDrill", Description: "掘洞钻（工具）"},
	{ID: "DruidsEye", Description: "德鲁伊之眼（工具）"},
	{ID: "DruidsEyes", Description: "德鲁伊双瞳（工具）"},
	{ID: "EggofFlealia", Description: "蚤母卵（工具）"},
	{ID: "FleaBrew", Description: "跳蚤蜜酿（工具）"},
	{ID: "Flintslate", Description: "燧石板（工具）"},
	{ID: "FracturedMask", Description: "碎面甲（工具）"},
	{ID: "InjectorBand", Description: "注丝套针（工具）"},
	{ID: "Longclaw", Description: "长爪（工具）"},
	{ID: "Longpin", Description: "长针（工具）"},
	{ID: "MagmaBell", Description: "熔岩钟（工具）"},
	{ID: "MagnetiteBrooch", Description: "磁石胸针（工具）"},
	{ID: "MagnetiteDice", Description: "磁石骰（工具）"},
	{ID: "MemoryCrystal", Description: "记忆晶石（工具）"},
	{ID: "Multibinder", Description: "多重缚丝器（工具）"},
	{ID: "NeedlePhial", Description: "储液针管（工具）"},
	{ID: "Pimpillo", Description: "爆燃囊（工具）"},
	{ID: "PinBadge", Description: "针徽（工具）"},
	{ID: "PlasmiumPhial", Description: "生质液瓶（工具）"},
	{ID: "PollipPouch", Description: "花芯囊（工具）"},
	{ID: "QuickSling", Description: "速射索（工具）"},
	{ID: "ReserveBind", Description: "储备缚丝（工具）"},
	{ID: "RosaryCannon", Description: "念珠炮（工具）"},
	{ID: "SawtoothCirclet", Description: "锯齿环（工具）"},
	{ID: "Scuttlebrace", Description: "迅捷脊锁（工具）"},
	{ID: "ShardPendant", Description: "碎壳坠（工具）"},
	{ID: "ShellSatchel", Description: "壳囊（工具）"},
	{ID: "SilkshotArchitect", Description: "丝弹-建筑师（工具）"},
	{ID: "SilkshotForge", Description: "丝弹-铁匠（工具）"},
	{ID: "SilkshotWeaver", Description: "丝弹-编织者（工具）"},
	{ID: "SilkspeedAnklets", Description: "丝速脚环（工具）"},
	{ID: "SnareSetter", Description: "陷阱设置器（工具）"},
	{ID: "SnitchPick", Description: "撬脏钩（工具）"},
	{ID: "SpiderStrings", Description: "蛛丝弦（工具）"},
	{ID: "SpoolExtender", Description: "储丝延展器（工具）"},
	{ID: "StingShard", Description: "蜇刺碎片（工具）"},
	{ID: "StraightPin", Description: "直针（工具）"},
	{ID: "Tacks", Description: "钉刺（工具）"},
	{ID: "ThiefsMark", Description: "窃者印记（工具）"},
	{ID: "ThreefoldPin", Description: "三重镖（工具）"},
	{ID: "ThrowingRing", Description: "投掷环（工具）"},
	{ID: "VoltFilament", Description: "伏特丝（工具）"},
	{ID: "Voltvessels", Description: "电枢球（工具）"},
	{ID: "WardingBell", Description: "护佑钟（工具）"},
	{ID: "Weavelight", Description: "织光仪（工具）"},
	...
	{ID: "BellBeastArenaExit", Description: "钟道兽战斗后（切图）"},
	{ID: "EnterHalfwayHome", Description: "进入中途酒馆（切图）"},
	{ID: "EnterGreatConchflies", Description: "进入巨型螺蝇（切图）"},
	{ID: "FirstSinnerArenaExit", Description: "原罪者战斗后（切图）"},
	{ID: "KarakSimpleKeyExit", Description: "卡拉卡沙川—简易钥匙后（切图）"},
	{ID: "HighHallsArenaExit", Description: "高庭遭遇战后（切图）"},
	{ID: "SeenWhiteward", Description: "初次进入白愈厅（区域）"},
	{ID: "TheUnravelledArenaExit", Description: "散茧魂渊遭遇战后（切图）"},
	{ID: "StraightPinTrans", Description: "直针（切图）"},
	{ID: "PimpilloTrans", Description: "爆燃囊（切图）"},
}
