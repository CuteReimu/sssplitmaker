...
var SplitsCache = []*SplitData{
	...
	{ID: "BenchAny", Description: "任意椅子（椅子）"},
	{ID: "MenuNeedolinMemory", Description: "织忆弦针忆境（菜单）"},
	{ID: "WardenflyCaptureTrans", Description: "遭遇狱卒蝇捕获（切图）"},
	{ID: "EnterCogworkCore", Description: "进入机枢核心（切图）"},
	{ID: "GreatTasteReward", Description: "纺络珍馐奖励（物品）"},
	{ID: "PostClawlineArenaTrans", Description: "飞针冲刺遭遇战后（切图）"},
	{ID: "PostLace2ArenaTrans", Description: "蕾丝2（切图）"},
	{ID: "EnterTheCradle", Description: "进入摇篮圣所（切图）"},
	{ID: "BellwayTrans", Description: "乘坐钟道兽（切图）"},
	{ID: "ShakraMapBuyout", Description: "沙克拉全地图（NPC）"},
}
