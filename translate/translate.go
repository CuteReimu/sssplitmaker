...
var SplitsCache = []*SplitData{
	...
	{"SecondSentinelAwoken", "唤醒次席戍卫（事件）"},
	{"EnterSecondSentinel", "进入次席戍卫（切图）"},
	{"SecondSentinelBossEncountered", "次席戍卫-遭遇（Boss）"},
	{"SecondSentinel", "次席戍卫（Boss）"},
	{"FleaFestivalBegin", "跳蚤庆典开始（事件）"},
	{"FleaFestivalEnd", "跳蚤庆典结束（事件）"},
	{"NylethEncountered", "尼莱斯-遭遇（Boss）"},
	{"Nyleth", "尼莱斯（Boss)"},
	{"KhannEncountered", "壳王卡汗-遭遇（Boss）"},
	{"CrustKingKhann", "壳王卡汗（Boss）"},
	{"SkarrsingerKarmelita", "斯卡尔歌后卡梅莉塔（Boss）"},
	{"Palestag", "苍白苜鹿（Boss）"},
	{"CloverDancersEncountered", "三叶草舞者-遭遇（Boss）"},
	{"CloverDancers", "三叶草舞者（Boss）"},
}
